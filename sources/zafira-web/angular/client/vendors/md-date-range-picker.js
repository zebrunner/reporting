        ...
        function show(config) {
            return $mdDialog.show({
                ...
                template: ['<md-dialog aria-label="Date Range Picker">',
                    ...
                    '<md-button ng-if="!config.autoConfirm" class="md-raised md-warn" ng-click="clear()">{{getLocalizationVal("Clear")}}</md-button>',
