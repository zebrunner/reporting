(function () {
    ...
    angular
        .module('app.services')
        .factory('MonitorsService', ['$httpMock', '$cookies', '$rootScope', 'UtilService', 'API_URL', MonitorsService])

    function MonitorsService($httpMock, $cookies, $rootScope, UtilService, API_URL) {
        var service = {};
