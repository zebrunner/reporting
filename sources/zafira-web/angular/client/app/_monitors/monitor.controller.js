(function () {
    ...
    angular
        .module('app.monitor')
        .controller('MonitorProfileController', ['$scope', '$location', '$state', 'UserService', 'UtilService', 'AuthService', MonitorProfileController])
        .controller('MonitorListController', ['$scope', '$rootScope', '$location', '$state', '$mdDialog', 'UserService', 'GroupService', 'UtilService', 'DashboardService', MonitorListController])

    // **************************************************************************
    function MonitorProfileController($scope, $location, $state, UserService, UtilService, AuthService) {
