...
window.echarts = require('echarts/dist/echarts-en.common.min'); //TODO: clarify which components are used and make own build of the plugin instead of requiring huge file
