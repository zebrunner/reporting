    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        try {
            ...
            if (!codeMatch && monitor.isNotificationsEnabled()) {
                MonitorEmailMessageNotification monitorEmailMessageNotification = new MonitorEmailMessageNotification(EMAIL_SUBJECT, EMAIL_TEXT,
                        monitor, actualResponseStatus);
                try {
