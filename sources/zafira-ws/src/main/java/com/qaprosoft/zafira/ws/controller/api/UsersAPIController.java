...
public class UsersAPIController extends AbstractController
{
	...
	@ResponseStatusDetails
	@ApiOperation(value = "Updates user profile", nickname = "updateUserProfile", code = 200, httpMethod = "PUT", response = UserType.class)
	@ResponseStatus(HttpStatus.OK)
	...
	@ResponseStatusDetails
	@ApiOperation(value = "Updates user password", nickname = "updateUserPassword", code = 200, httpMethod = "PUT")
	@ResponseStatus(HttpStatus.OK)
