...
public class TestRunsAPIController extends AbstractController {
    ...
    public @ResponseBody
    TestRunType startTestRun(@RequestBody @Valid TestRunType tr, @RequestHeader(value="Project", required=false) String project) throws ServiceException, MappingException, JAXBException
    {
    ...
    public @ResponseBody
    SearchResult<TestRun> searchTestRuns(@RequestBody TestRunSearchCriteria sc) throws ServiceException
    {
    ...
    public @ResponseBody
    List<TestType> getTestRunResults(@PathVariable(value="id") long id) throws ServiceException
    {
