...
public class TestRunsAPIController extends AbstractController {
    ...
    public void debugTestRun(@PathVariable("id") long id) {
        ...
        jenkinsService.debugJob(testRun.getJob(), testRun.getBuildNumber());
    }
    ...
    public void buildTestRun(
        ...
        if (buildWithParameters) {
            jenkinsService.buildJob(testRun.getJob(), jobParameters);
        } else {
    ...
    public Map<Integer, String> getConsoleOutput(
        ...
        return jenkinsService.getBuildConsoleOutput(testRun.getJob(), testRun.getBuildNumber(), count, fullCount);
    }
