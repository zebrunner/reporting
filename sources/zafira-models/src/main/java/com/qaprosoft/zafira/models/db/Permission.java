...
public class Permission extends AbstractEntity implements Comparable<Permission>
{
	...
	public enum Block
	{
		DASHBOARDS, TEST_RUNS, TEST_RUN_VIEWS, INVITATIONS, USERS, SETTINGS, MONITORS, PROJECTS, INTEGRATIONS, LAUNCHERS
	}
	...
	public enum Name
	{
		...
		MODIFY_WIDGETS,
		MODIFY_TEST_RUNS, TEST_RUNS_CI,
		MODIFY_TEST_RUN_VIEWS, VIEW_TEST_RUN_VIEWS,
		MODIFY_TESTS,
