...
public class Setting extends AbstractEntity
{
	...
	public enum SettingType
	{
		...
		AMAZON_ACCESS_KEY, AMAZON_SECRET_KEY, AMAZON_BUCKET, AMAZON_IMAGE_FOLDER, AMAZON_ENABLED,
		HIPCHAT_ACCESS_TOKEN, HIPCHAT_ENABLED,
		CRYPTO_KEY_TYPE, CRYPTO_ALGORITHM, CRYPTO_KEY_SIZE, KEY, 
		RABBITMQ_ENABLED, RABBITMQ_HOST, RABBITMQ_PORT, RABBITMQ_WS, RABBITMQ_USER, RABBITMQ_PASSWORD,
		COMPANY_LOGO_URL
	}

	public enum Tool
	{
		JIRA, JENKINS, SLACK, EMAIL, AMAZON, HIPCHAT, LDAP, CRYPTO, RABBITMQ
	}
