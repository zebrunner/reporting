package com.zafira.services.aspects;
...
public class ServiceExceptionAspect
{
	...
	@AfterThrowing(pointcut = "execution(public * com.zafira.services.services..*.*(..) throws com.zafira.services.exceptions.ServiceException)", throwing = "e")
