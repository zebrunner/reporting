...
@Component
public class AutomationServerService extends AbstractIntegration<AutomationServerAdapter> {
    ...
    public AutomationServerService() {
        super("JENKINS");
    }

    public boolean rerunJob(Job ciJob, Integer buildNumber, boolean rerunFailures) {
        JobResult jobResult = null;
        AutomationServerAdapter automationServerAdapter = getAdapterById(ciJob.getAutomationServerId());
        try {
    ...
    public JobResult buildJob(Job job, Map<String, String> jobParameters) {
        AutomationServerAdapter automationServerAdapter = getAdapterById(job.getAutomationServerId());
    ...
    public JobResult buildScannerJob(String repositoryName, Map<String, String> jobParameters, boolean rescan) {
        AutomationServerAdapter automationServerAdapter = getDefaultAdapter();
