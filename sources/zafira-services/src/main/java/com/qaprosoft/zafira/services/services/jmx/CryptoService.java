...
import com.qaprosoft.zafira.services.services.jmx.models.CryptoType;
...
public class CryptoService implements IJMXService<CryptoType>
{
	...
	public void generateKey() throws Exception
	{
		...
		try
		{
			key = new String(Base64.encodeBase64(generateKey(getCryptoType().getType(), getCryptoType().getSize()).getEncoded()));
		}
		catch (Exception e)
		{
