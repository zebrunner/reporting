...
public class LauncherCallbackService {
    ...
    public LauncherCallback retrieveByCiRunId(String ciRunId) {
        ...
        if (launcherCallback == null) {
            throw new ResourceNotFoundException(String.format(ERR_MSG_LAUNCHER_CALLBACK_NOT_FOUND_BY_CI_RUN_ID, ciRunId));
        }
    ...
    public LauncherCallback retrieveByReference(String ref) {
        ...
        if (launcherCallback == null) {
            throw new ResourceNotFoundException(String.format(ERR_MSG_LAUNCHER_CALLBACK_NOT_FOUND_BY_REF, ref));
        }
        return launcherCallback;
    }
