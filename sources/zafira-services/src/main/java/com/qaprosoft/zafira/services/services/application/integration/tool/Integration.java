...
import com.qaprosoft.zafira.services.services.application.integration.tool.context.adapter.AbstractAdapter;

import java.util.Optional;
import java.util.function.Function;

public interface Integration<T extends AbstractAdapter> {
