...
import com.qaprosoft.zafira.service.integration.tool.impl.google.auth.GoogleSheetsAuthService;
...
public class GoogleSpreadsheetsService extends AbstractGoogleService {
    ...
    public BatchUpdateValuesResponse writeValuesIntoSpreadsheet(String spreadsheetId, String range, List<List<Object>> insertValues)
            throws IOException {
    ...
    public BatchUpdateValuesResponse writeValuesIntoSpreadsheet(String spreadsheetId, List<List<Object>> insertValues, String sheetName)
            throws IOException {
    ...
    public Request setCellsStyle(int sheetId, int startRowIndex, int endRowIndex, int startColumnIndex, int endColumnIndex, boolean center,
            int fontSize, String fontFamily, boolean bold) {
