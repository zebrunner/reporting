 ...
 *******************************************************************************/
package com.qaprosoft.zafira.listener.testng;
 ...
 * @author akhursevich
 */
public class TestNGListener implements ISuiteListener, ITestListener, IHookable, IInvokedMethodListener {

    private final ZafiraListener listener;

    public TestNGListener() {
        this.listener = new ZafiraListenerImpl();
    }
