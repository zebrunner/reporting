...
ALTER TABLE JOBS ADD COLUMN AUTOMATION_SERVER_ID VARCHAR(50) NULL;
ALTER TABLE JOBS ADD CONSTRAINT fk_JOBS_AUTOMATION_SERVER_ID1
    FOREIGN KEY (AUTOMATION_SERVER_ID)
        REFERENCES INTEGRATIONS (BACK_REFERENCE_ID)
        ON DELETE NO ACTION
        ON UPDATE NO ACTION;
...
DO $$
    ...
    BEGIN
        ...
        FOR JOB_ROW IN SELECT * FROM JOBS
            LOOP
                UPDATE JOBS SET AUTOMATION_SERVER_ID = 'DEFAULT_JOB_AUTOMATION_SERVER_ID' WHERE AUTOMATION_SERVER_ID IS NULL;
            END LOOP;

        RETURN;
    END$$;

ALTER TABLE JOBS ALTER COLUMN AUTOMATION_SERVER_ID SET NOT NULL;
