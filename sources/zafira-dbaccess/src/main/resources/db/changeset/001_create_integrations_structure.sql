...
CREATE TABLE IF NOT EXISTS INTEGRATION_GROUPS (
                                                  ...
                                                  MULTIPLE_ALLOWED BOOLEAN NULL DEFAULT FALSE,
                ...
                FOR SETTING_ROW IN SELECT * FROM SETTINGS WHERE TOOL = SETTING_TOOL ORDER BY CASE WHEN NAME = CONCAT(SETTING_TOOL, '_ENABLED') THEN 0 ELSE 1 END
                    LOOP
                        ...
                        ELSE
                            ...
                            INSERT INTO INTEGRATION_PARAMS(NAME, MANDATORY, INTEGRATION_TYPE_ID) VALUES (SETTING_ROW.NAME, INTEGRATION_PARAM_MANDATORY, INTEGRATION_TYPE_ID) RETURNING ID INTO INTEGRATION_SETTING_INTEGRATION_PARAM_ID;
                            INSERT INTO INTEGRATION_SETTINGS(INTEGRATION_ID, INTEGRATION_PARAM_ID, VALUE, BINARY_DATA) VALUES(INTEGRATION_ID, INTEGRATION_SETTING_INTEGRATION_PARAM_ID, SETTING_ROW.VALUE, SETTING_ROW.FILE);
                        END IF;
                    END LOOP;
