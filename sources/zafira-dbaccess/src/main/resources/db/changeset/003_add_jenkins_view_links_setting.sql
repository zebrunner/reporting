DO $$
    ...
    BEGIN
        ...
        INSERT INTO INTEGRATION_PARAMS(name, metadata, mandatory, need_encryption, integration_type_id) VALUES ('JENKINS_URL_VISIBILITY', BOOLEAN_METADATA, false, false, INTEGRATION_TYPE_ID_VAR) RETURNING id INTO INTEGRATION_PARAM_ID_VAR;
