...
echo zafira.elasticsearch.host=$ZAFIRA_ELASTICSEARCH_HOST >> $CATALINA_HOME/conf/catalina.properties
echo zafira.elasticsearch.port=$ZAFIRA_ELASTICSEARCH_PORT >> $CATALINA_HOME/conf/catalina.properties
