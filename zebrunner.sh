...
setup() {
    ...
    replace configuration/reporting-service/variables.env "GITHUB_HOST=github.com" "GITHUB_HOST=${ZBR_GITHUB_HOST}"
    replace configuration/reporting-service/variables.env "GITHUB_CLIENT_ID=" "GITHUB_CLIENT_ID=${ZBR_GITHUB_CLIENT_ID}"
