...
CREATE UNIQUE INDEX user_preferences_ID_uindex ON zafira.user_preferences (ID);
CREATE UNIQUE INDEX user_preferences_NAME_uindex ON zafira.user_preferences (NAME);
