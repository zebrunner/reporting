...
('READ_HIDDEN_DASHBOARD', 'DASHBOARDS'),
('WRITE_DASHBOARD', 'DASHBOARDS'),
('WRITE_WIDGET', 'DASHBOARDS'),
('WRITE_TEST_RUN_VIEW', 'TEST_RUNS'),
('WRITE_TEST_RUN', 'TEST_RUNS'),
('CI_TEST_RUN', 'TEST_RUNS'),
('WRITE_TEST', 'TEST_RUNS'),
('WRITE_USER', 'USERS'),
('WRITE_USER_GROUP', 'USERS'),
('READ_USER', 'USERS'),
('WRITE_SETTING', 'SETTINGS'),
('READ_SETTING', 'SETTINGS'),
('WRITE_MONITOR', 'MONITORS'),
('READ_MONITOR', 'MONITORS'),
('WRITE_PROJECT', 'PROJECTS'),
('WRITE_INTEGRATION', 'INTEGRATIONS'),
