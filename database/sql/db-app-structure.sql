...
CREATE TRIGGER update_timestamp_user_launcher_preferences BEFORE INSERT OR UPDATE ON user_launcher_preferences FOR EACH ROW EXECUTE PROCEDURE update_timestamp();
