...
DO $$
    ...
    BEGIN
        ...
        -- RabbitMQ
        INSERT INTO INTEGRATION_GROUPS(NAME, ICON_URL, MULTIPLE_ALLOWED) VALUES ('MESSAGE_BROKER', '', FALSE) RETURNING ID INTO INTEGRATION_GROUP_ID;
        ...
        INSERT INTO INTEGRATIONS(NAME, INTEGRATION_TYPE_ID, "DEFAULT") VALUES ('RABBITMQ', INTEGRATION_TYPE_ID, TRUE) RETURNING ID INTO INTEGRATION_ID;
        ...
        -- Google, mail, slack
        INSERT INTO INTEGRATION_GROUPS(NAME, ICON_URL, MULTIPLE_ALLOWED) VALUES ('MESSENGERS_REPORTING', '', FALSE) RETURNING ID INTO INTEGRATION_GROUP_ID;
        --      Google
        ...
        INSERT INTO INTEGRATIONS(NAME, INTEGRATION_TYPE_ID, "DEFAULT") VALUES ('GOOGLE', INTEGRATION_TYPE_ID, TRUE) RETURNING ID INTO INTEGRATION_ID;
        ...
        INSERT INTO INTEGRATIONS(NAME, INTEGRATION_TYPE_ID, "DEFAULT") VALUES ('EMAIL', INTEGRATION_TYPE_ID, TRUE) RETURNING ID INTO INTEGRATION_ID;
        ...
        INSERT INTO INTEGRATIONS(NAME, INTEGRATION_TYPE_ID, "DEFAULT") VALUES ('SLACK', INTEGRATION_TYPE_ID, TRUE) RETURNING ID INTO INTEGRATION_ID;
        ...
        -- Amazon
        INSERT INTO INTEGRATION_GROUPS(NAME, ICON_URL, MULTIPLE_ALLOWED) VALUES ('STORAGE_PROVIDER', '', FALSE) RETURNING ID INTO INTEGRATION_GROUP_ID;
        ...
        INSERT INTO INTEGRATIONS(NAME, INTEGRATION_TYPE_ID, "DEFAULT") VALUES ('AMAZON', INTEGRATION_TYPE_ID, TRUE) RETURNING ID INTO INTEGRATION_ID;
        ...
        -- LDAP
        INSERT INTO INTEGRATION_GROUPS(NAME, ICON_URL, MULTIPLE_ALLOWED) VALUES ('ACCESS_MANAGEMENT', '', FALSE) RETURNING ID INTO INTEGRATION_GROUP_ID;
        ...
        INSERT INTO INTEGRATIONS(NAME, INTEGRATION_TYPE_ID, "DEFAULT") VALUES ('LDAP', INTEGRATION_TYPE_ID, TRUE) RETURNING ID INTO INTEGRATION_ID;
        ...
        -- Selenium
        INSERT INTO INTEGRATION_GROUPS(NAME, ICON_URL, MULTIPLE_ALLOWED) VALUES ('TEST_AUTOMATION_TOOL', '', FALSE) RETURNING ID INTO INTEGRATION_GROUP_ID;
        ...
        INSERT INTO INTEGRATIONS(NAME, INTEGRATION_TYPE_ID, "DEFAULT") VALUES ('SELENIUM', INTEGRATION_TYPE_ID, TRUE) RETURNING ID INTO INTEGRATION_ID;
        ...
        -- Jenkins
        INSERT INTO INTEGRATION_GROUPS(NAME, ICON_URL, MULTIPLE_ALLOWED) VALUES ('AUTOMATION_SERVER', '', TRUE) RETURNING ID INTO INTEGRATION_GROUP_ID;
        ...
        INSERT INTO INTEGRATIONS(NAME, INTEGRATION_TYPE_ID, "DEFAULT") VALUES ('JENKINS', INTEGRATION_TYPE_ID, TRUE) RETURNING ID INTO INTEGRATION_ID;
        ...
        -- Jira, testrail, qtest
        INSERT INTO INTEGRATION_GROUPS(NAME, ICON_URL, MULTIPLE_ALLOWED) VALUES ('TEST_CASE_MANAGEMENT', '', FALSE) RETURNING ID INTO INTEGRATION_GROUP_ID;
        --      Jira
        ...
        INSERT INTO INTEGRATIONS(NAME, INTEGRATION_TYPE_ID, "DEFAULT") VALUES ('JIRA', INTEGRATION_TYPE_ID, TRUE) RETURNING ID INTO INTEGRATION_ID;
        ...
        INSERT INTO INTEGRATION_SETTINGS(INTEGRATION_ID, INTEGRATION_PARAM_ID, VALUE) VALUES (INTEGRATION_ID, INTEGRATION_PARAM_ID, 'CLOSED');
        ...
        INSERT INTO INTEGRATIONS(NAME, INTEGRATION_TYPE_ID, "DEFAULT") VALUES ('TESTRAIL', INTEGRATION_TYPE_ID, TRUE) RETURNING ID INTO INTEGRATION_ID;
        ...
        INSERT INTO INTEGRATIONS(NAME, INTEGRATION_TYPE_ID, "DEFAULT") VALUES ('QTEST', INTEGRATION_TYPE_ID, TRUE) RETURNING ID INTO INTEGRATION_ID;
