...
DO $$
  ...
  BEGIN
    ...
    INSERT INTO PERMISSIONS (NAME, BLOCK) VALUES ('MODIFY_SETTINGS', 'SETTINGS') RETURNING id INTO PERMISSION_ID;
    INSERT INTO GROUP_PERMISSIONS (GROUP_ID, PERMISSION_ID) VALUES (SUPER_ADMINS_GROUP_ID, PERMISSION_ID);

    INSERT INTO PERMISSIONS (NAME, BLOCK) VALUES ('VIEW_SETTINGS', 'SETTINGS') RETURNING id INTO PERMISSION_ID;
    INSERT INTO GROUP_PERMISSIONS (GROUP_ID, PERMISSION_ID) VALUES (SUPER_ADMINS_GROUP_ID, PERMISSION_ID),
                                                                   (ADMINS_GROUP_ID, PERMISSION_ID);

    INSERT INTO PERMISSIONS (NAME, BLOCK) VALUES ('MODIFY_MONITORS', 'MONITORS') RETURNING id INTO PERMISSION_ID;
    INSERT INTO GROUP_PERMISSIONS (GROUP_ID, PERMISSION_ID) VALUES (SUPER_ADMINS_GROUP_ID, PERMISSION_ID);

    INSERT INTO PERMISSIONS (NAME, BLOCK) VALUES ('VIEW_MONITORS', 'MONITORS') RETURNING id INTO PERMISSION_ID;
    INSERT INTO GROUP_PERMISSIONS (GROUP_ID, PERMISSION_ID) VALUES (SUPER_ADMINS_GROUP_ID, PERMISSION_ID);
