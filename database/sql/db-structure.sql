...
CREATE VIEW NIGHTLY_VIEW AS (
  ...
  WHERE TESTS.CREATED_AT >= date_trunc('day', current_date)
        AND TEST_RUNS.STARTED_AT >= date_trunc('day', current_date)
  GROUP BY PROJECTS.NAME, TEST_RUNS.ID, USERS.ID, TEST_CONFIGS.PLATFORM, TEST_CONFIGS.BROWSER, TEST_CONFIGS.APP_VERSION, JOBS.JOB_URL, JOBS.NAME, TEST_SUITES.NAME, TEST_SUITES.USER_ID
);
