...
CREATE MATERIALIZED VIEW BIMONTHLY_VIEW AS (
  ...
  GROUP BY PROJECT, TEST_RUNS.ID, USERS.ID, TEST_CONFIGS.PLATFORM, TEST_CONFIGS.PLATFORM_VERSION, TEST_CONFIGS.BROWSER, TEST_CONFIGS.BROWSER_VERSION,
    TEST_CONFIGS.DEVICE, TEST_CONFIGS.URL, TEST_CONFIGS.LOCALE, TEST_CONFIGS.LANGUAGE, TEST_CONFIGS.APP_VERSION, JOBS.JOB_URL, JOBS.NAME, TEST_SUITES.USER_ID);
...
CREATE MATERIALIZED VIEW NIGHTLY_FAILURES_VIEW AS (
  ...
  WHERE TESTS.CREATED_AT >= date_trunc('day', current_date)
        AND TEST_RUNS.STARTED_AT >= date_trunc('day', current_date)
  GROUP BY TESTS.ID, TEST_RUNS.ID, GROUPS.NAME, USERS.ID, TEST_RUNS.ENV, TEST_CONFIGS.PLATFORM, TEST_CONFIGS.BROWSER, TEST_RUNS.BUILD_NUMBER, TEST_CONFIGS.URL, JOBS.NAME, JOBS.JOB_URL);
