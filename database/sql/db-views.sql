...
SELECT    PROJECTS.NAME AS PROJECT,
	  ...
	  TEST_RUNS.CREATED_AT AS CREATED_AT,
          ...
          '<a href="dashboards/1?testCaseId=' || TEST_CASES.ID || '">' || TEST_CASES.TEST_METHOD || '</a>' AS STABILITY_URL,
          sum( case when TESTS.STATUS = 'PASSED' then 1 else 0 end ) AS PASSED,
          sum( case when TESTS.STATUS = 'FAILED' AND TESTS.KNOWN_ISSUE=FALSE then 1 else 0 end ) AS FAILED,
          sum( case when TESTS.STATUS = 'FAILED' AND TESTS.KNOWN_ISSUE=TRUE then 1 else 0 end ) AS KNOWN_ISSUE,
          sum( case when TESTS.STATUS = 'SKIPPED' then 1 else 0 end ) AS SKIPPED,
...
DROP MATERIALIZED VIEW IF EXISTS LAST30DAYS_VIEW;
CREATE MATERIALIZED VIEW LAST30DAYS_VIEW AS (
SELECT    PROJECTS.NAME AS PROJECT,
          USERS.ID AS OWNER_ID,
          USERS.USERNAME AS OWNER_USERNAME,
          USERS.EMAIL AS OWNER_EMAIL,
...
DROP INDEX IF EXISTS LAST30DAYS_VIEW_PROJECT_INDEX;
CREATE INDEX LAST30DAYS_VIEW_PROJECT_INDEX ON LAST30DAYS_VIEW (PROJECT);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_OWNER_ID_INDEX;
CREATE INDEX LAST30DAYS_VIEW_OWNER_ID_INDEX ON LAST30DAYS_VIEW (OWNER_ID);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_OWNER_INDEX;
CREATE INDEX LAST30DAYS_VIEW_OWNER_INDEX ON LAST30DAYS_VIEW (OWNER_USERNAME);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_EMAIL_INDEX;
CREATE INDEX LAST30DAYS_VIEW_EMAIL_INDEX ON LAST30DAYS_VIEW (OWNER_EMAIL);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_OWNER_FIRST_NAME_INDEX;
CREATE INDEX LAST30DAYS_VIEW_OWNER_FIRST_NAME_INDEX ON LAST30DAYS_VIEW (OWNER_FIRST_NAME);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_OWNER_LAST_NAME_INDEX;
CREATE INDEX LAST30DAYS_VIEW_OWNER_LAST_NAME_INDEX ON LAST30DAYS_VIEW (OWNER_LAST_NAME);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_OWNER_LAST_LOGIN_INDEX;
CREATE INDEX LAST30DAYS_VIEW_OWNER_LAST_LOGIN_INDEX ON LAST30DAYS_VIEW (OWNER_LAST_LOGIN);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_OWNER_COVER_PHOTO_URL_INDEX;
CREATE INDEX LAST30DAYS_VIEW_OWNER_COVER_PHOTO_URL_INDEX ON LAST30DAYS_VIEW (OWNER_COVER_PHOTO_URL);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_OWNER_CREATED_AT_INDEX;
CREATE INDEX LAST30DAYS_VIEW_OWNER_CREATED_AT_INDEX ON LAST30DAYS_VIEW (OWNER_CREATED_AT);
                                                                                          
DROP INDEX IF EXISTS LAST30DAYS_VIEW_ENV_INDEX;
CREATE INDEX LAST30DAYS_VIEW_ENV_INDEX ON LAST30DAYS_VIEW (ENV);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_PLATFORM_INDEX;
CREATE INDEX LAST30DAYS_VIEW_PLATFORM_INDEX ON LAST30DAYS_VIEW (PLATFORM);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_PLATFORM_VERSION_INDEX;
CREATE INDEX LAST30DAYS_VIEW_PLATFORM_VERSION_INDEX ON LAST30DAYS_VIEW (PLATFORM_VERSION);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_BROWSER_INDEX;
CREATE INDEX LAST30DAYS_VIEW_BROWSER_INDEX ON LAST30DAYS_VIEW (BROWSER);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_BROWSER_VERSION_INDEX;
CREATE INDEX LAST30DAYS_VIEW_BROWSER_VERSION_INDEX ON LAST30DAYS_VIEW (BROWSER_VERSION);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_APP_VERSION_INDEX;
CREATE INDEX LAST30DAYS_VIEW_APP_VERSION_INDEX ON LAST30DAYS_VIEW (APP_VERSION);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_DEVICE_INDEX;
CREATE INDEX LAST30DAYS_VIEW_DEVICE_INDEX ON LAST30DAYS_VIEW (DEVICE);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_URL_INDEX;
CREATE INDEX LAST30DAYS_VIEW_URL_INDEX ON LAST30DAYS_VIEW (URL);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_LOCALE_INDEX;
CREATE INDEX LAST30DAYS_VIEW_LOCALE_INDEX ON LAST30DAYS_VIEW (LOCALE);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_LANGUAGE_INDEX;
CREATE INDEX LAST30DAYS_VIEW_LANGUAGE_INDEX ON LAST30DAYS_VIEW (LANGUAGE);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_JOB_INDEX;
CREATE INDEX LAST30DAYS_VIEW_JOB_INDEX ON LAST30DAYS_VIEW (JOB_URL);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_JOB_NAME_INDEX;
CREATE INDEX LAST30DAYS_VIEW_JOB_NAME_INDEX ON LAST30DAYS_VIEW (JOB_NAME);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_JOB_OWNER_ID_INDEX;
CREATE INDEX LAST30DAYS_VIEW_JOB_OWNER_ID_INDEX ON LAST30DAYS_VIEW (JOB_OWNER_ID);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_TEST_SUITE_NAME_INDEX;
CREATE INDEX LAST30DAYS_VIEW_TEST_SUITE_NAME_INDEX ON LAST30DAYS_VIEW (TEST_SUITE_NAME);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_TEST_RUN_ID_INDEX;
CREATE INDEX LAST30DAYS_VIEW_TEST_RUN_ID_INDEX ON LAST30DAYS_VIEW (TEST_RUN_ID);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_TEST_RUN_STATUS_INDEX;
CREATE INDEX LAST30DAYS_VIEW_TEST_RUN_STATUS_INDEX ON LAST30DAYS_VIEW (TEST_RUN_STATUS);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_SCM_URL_INDEX;
CREATE INDEX LAST30DAYS_VIEW_SCM_URL_INDEX ON LAST30DAYS_VIEW (SCM_URL);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_BUILD_NUMBER_INDEX;
CREATE INDEX LAST30DAYS_VIEW_BUILD_NUMBER_INDEX ON LAST30DAYS_VIEW (BUILD_NUMBER);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_ELAPSED_INDEX;
CREATE INDEX LAST30DAYS_VIEW_ELAPSED_INDEX ON LAST30DAYS_VIEW (ELAPSED);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_STARTED_AT_INDEX;
CREATE INDEX LAST30DAYS_VIEW_STARTED_AT_INDEX ON LAST30DAYS_VIEW (STARTED_AT);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_CREATED_AT_INDEX;
CREATE INDEX LAST30DAYS_VIEW_CREATED_AT_INDEX ON LAST30DAYS_VIEW (CREATED_AT);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_TEST_INFO_URL_INDEX;
CREATE INDEX LAST30DAYS_VIEW_TEST_INFO_URL_INDEX ON LAST30DAYS_VIEW (TEST_INFO_URL);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_UPSTREAM_JOB_ID_INDEX;
CREATE INDEX LAST30DAYS_VIEW_UPSTREAM_JOB_ID_INDEX ON LAST30DAYS_VIEW (UPSTREAM_JOB_ID);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_UPSTREAM_JOB_BUILD_NUMBER_INDEX;
CREATE INDEX LAST30DAYS_VIEW_UPSTREAM_JOB_BUILD_NUMBER_INDEX ON LAST30DAYS_VIEW (UPSTREAM_JOB_BUILD_NUMBER);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_UPSTREAM_JOB_NAME_INDEX;
CREATE INDEX LAST30DAYS_VIEW_UPSTREAM_JOB_NAME_INDEX ON LAST30DAYS_VIEW (UPSTREAM_JOB_NAME);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_UPSTREAM_JOB_URL_INDEX;
CREATE INDEX LAST30DAYS_VIEW_UPSTREAM_JOB_URL_INDEX ON LAST30DAYS_VIEW (UPSTREAM_JOB_URL);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_PRIORITY_INDEX;
CREATE INDEX LAST30DAYS_VIEW_PRIORITY_INDEX ON LAST30DAYS_VIEW (PRIORITY);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_FEATURE_INDEX;
CREATE INDEX LAST30DAYS_VIEW_FEATURE_INDEX ON LAST30DAYS_VIEW (FEATURE);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_KNOWN_ISSUE_INDEX;
CREATE INDEX LAST30DAYS_VIEW_KNOWN_ISSUE_INDEX ON LAST30DAYS_VIEW (KNOWN_ISSUE);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_BLOCKER_INDEX;
CREATE INDEX LAST30DAYS_VIEW_BLOCKER_INDEX ON LAST30DAYS_VIEW (BLOCKER);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_ETA_INDEX;
CREATE INDEX LAST30DAYS_VIEW_ETA_INDEX ON LAST30DAYS_VIEW (ETA);

DROP INDEX IF EXISTS LAST30DAYS_VIEW_REVIEWED_INDEX;
CREATE INDEX LAST30DAYS_VIEW_REVIEWED_INDEX ON LAST30DAYS_VIEW (REVIEWED);
...
CREATE MATERIALIZED VIEW TOTAL_VIEW AS (
 SELECT  PROJECTS.NAME AS PROJECT,
  ...
  WHERE TESTS.FINISH_TIME IS NOT NULL
		...
		date_trunc('month', TESTS.CREATED_AT), PRIORITY_TAGS.VALUE, FEATURE_TAGS.VALUE, TEST_CASES.ID
 UNION
 SELECT  PROJECT AS PROJECT,
         OWNER_ID AS OWNER_ID,
         OWNER_USERNAME AS OWNER_USERNAME,
         OWNER_EMAIL AS OWNER_EMAIL,
         OWNER_FIRST_NAME AS OWNER_FIRST_NAME,
         OWNER_LAST_NAME AS OWNER_LAST_NAME,
         OWNER_LAST_LOGIN AS OWNER_LAST_LOGIN,
         OWNER_COVER_PHOTO_URL AS OWNER_COVER_PHOTO_URL,
         ENV as ENV,
         PRIORITY AS PRIORITY,
         FEATURE AS FEATURE,
         PLATFORM AS PLATFORM,
	 STABILITY_URL AS STABILITY_URL,
         PASSED AS PASSED,
         FAILED AS FAILED,
         KNOWN_ISSUE AS KNOWN_ISSUE,
         SKIPPED AS SKIPPED,
         ABORTED AS ABORTED,
         ...
         ROUND(SUM(TOTAL_SECONDS)/extract(day from current_date) * extract(day from date_trunc('day', date_trunc('month', current_date) + interval '1 month') - interval '1 day')) AS TOTAL_ETA_SECONDS,
         AVG_TIME as AVG_TIME 
 FROM MONTHLY_VIEW
        GROUP BY PROJECT, OWNER_ID, OWNER_USERNAME, OWNER_EMAIL, OWNER_FIRST_NAME, OWNER_LAST_NAME, OWNER_LAST_LOGIN, OWNER_COVER_PHOTO_URL,
			ENV, PLATFORM, STABILITY_URL,
			PASSED, FAILED, KNOWN_ISSUE, SKIPPED, ABORTED, IN_PROGRESS, QUEUED, TOTAL,
			date_trunc('year', CREATED_AT), date_trunc('quarter', CREATED_AT), date_trunc('month', CREATED_AT), PRIORITY, FEATURE,
