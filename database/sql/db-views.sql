...
CREATE UNIQUE INDEX LAST32DAYS_VIEW_PROJECT_INDEX ON LAST32DAYS_VIEW (ID);
...
DROP INDEX IF EXISTS LAST32DAYS_VIEW_BLOCKER_INDEX;
CREATE INDEX LAST32DAYS_VIEW_BLOCKER_INDEX ON LAST32DAYS_VIEW (BLOCKER);
