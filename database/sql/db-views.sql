...
CREATE MATERIALIZED VIEW THIRTY_DAYS_VIEW AS (
  SELECT  row_number() OVER () AS ID,
          ...
          TEST_RUNS.BUILD_NUMBER As JOB_BUILD,
          '<a href="' || JOBS.JOB_URL  || '/' || CAST(TEST_RUNS.BUILD_NUMBER AS text) || '/ZafiraReport' || '" target="_blank">' || JOBS.NAME || '</a>' as ZAFIRA_REPORT,
...
CREATE INDEX THIRTY_DAYS_VIEW_OWNER_INDEX ON THIRTY_DAYS_VIEW (OWNER);

DROP INDEX IF EXISTS THIRTY_DAYS_VIEW_EMAIL_INDEX;
CREATE INDEX THIRTY_DAYS_VIEW_EMAIL_INDEX ON THIRTY_DAYS_VIEW (EMAIL);
...
DROP INDEX IF EXISTS THIRTY_DAYS_VIEW_BROWSER_INDEX;
CREATE INDEX THIRTY_DAYS_VIEW_BROWSER_INDEX ON THIRTY_DAYS_VIEW (BUILD);
...
DROP INDEX IF EXISTS THIRTY_DAYS_VIEW_JOB_BUILD_INDEX;
CREATE INDEX THIRTY_DAYS_VIEW_JOB_BUILD_INDEX ON THIRTY_DAYS_VIEW (JOB_BUILD);
...
DROP INDEX IF EXISTS THIRTY_DAYS_VIEW_STARTED_INDEX;
CREATE INDEX THIRTY_DAYS_VIEW_STARTED_INDEX ON THIRTY_DAYS_VIEW (STARTED);
...
DROP INDEX IF EXISTS THIRTY_DAYS_VIEW_ZAFIRA_REPORT_INDEX;
CREATE INDEX THIRTY_DAYS_VIEW_ZAFIRA_REPORT_INDEX ON THIRTY_DAYS_VIEW (ZAFIRA_REPORT);

DROP INDEX IF EXISTS THIRTY_DAYS_VIEW_REBUILD_INDEX;
CREATE INDEX THIRTY_DAYS_VIEW_REBUILD_INDEX ON THIRTY_DAYS_VIEW (REBUILD);
...
CREATE VIEW NIGHTLY_FAILURES_VIEW AS (
  SELECT
    ...
    TEST_RUNS.STATUS AS TEST_RUN_STATUS,
    TEST_RUNS.BUILD_NUMBER AS JOB_BUILD,
    '<a href="#!/tests/runs/' || TEST_RUNS.ID || '/info/' || TESTS.ID || '" target="_blank">' || JOBS.NAME || '</a>' AS TEST_REPORT,
