...
ENV ZAFIRA_SCM_GITHUB_CLIENT_ID=
ENV ZAFIRA_SCM_GITHUB_CLIENT_SECRET=

ENV ZAFIRA_JWT_SECRET=abc
ENV ZAFIRA_ADMIN_USERNAME=aaa
ENV ZAFIRA_ADMIN_PASSWORD=aaa
ENV ZAFIRA_ADMIN_GROUP=aaa
ENV ZAFIRA_WS_PATH=zafira-ws
